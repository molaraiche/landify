...
const CTA = () => {
  return (
    <section className='bg-primary-600'>
      <div className='lg:container lg:mx-auto md:px-14 sm:px-10 xsm:px-4 flex lg:flex-row md:flex-col sm:flex-col xsm:flex-col items-center justify-between gap-8 lg:h-[44vh] md:min-h-[44vh] sm:min-h-[44vh] xsm:min-h-[44vh]'>
        ...
        <div className='flex lg:h-[400px] lg:space-between lg:flex-row md:flex-row sm:flex-col xsm:flex-col '>
          <Image
